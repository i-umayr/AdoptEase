                ...
                <div class="card-body">
                    <form method="POST" action="/register_adopter">
                        ...
                        <div class="row mb-3 mt-3 row">
                            ...
                            <div class="col-md-6">
                                <input id="occupation" type="text" class="form-control @error('email') is-invalid @enderror" name="occupation" value="{{ old('occupation') }}" required autocomplete="occupation">
                                @error('occupation')
                                <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                            @enderror
                            </div>
                        ...
                        <!-- income  -->
                        <div class="row mb-3">
                            <label for="income" class="col-md-4 col-form-label text-md-end">{{ __('Income') }}</label>
                            <div class="col-md-6">
